 ...
 * @Date 10:28 2019/4/18
 * @Param 
 * @return 
 **/
public class RedisCacheManager {

    static RedisTemplate redisTemplate = OtterContextLocator.getRedisTemplate();
    ...
    public static boolean sSetAndTime(String key, long time, Object... values) {
        try {
            boolean flag = redisTemplate.opsForSet().add(key, values);
            if (time > 0)
                expire(key, time);
            return flag;
        } catch (Exception e) {
    ...
    public static boolean setRemove(String key, Object... values) {
        try {
            boolean flag = redisTemplate.opsForSet().remove(key, values);
            return flag;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
